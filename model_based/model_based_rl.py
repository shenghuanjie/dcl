...
from model_based.model_based_policy import ModelBasedPolicy
import model_based.utils as utils
from model_based.logger import logger
from model_based.timer import timeit
...
def setup_logger(logdir, locals_):
    ...
    params = {k: locals_[k] for k in locals_}
...
class ModelBasedRL(object):
    ...
    def _train_policy(self, dataset):
        ...
        for _ in range(self._training_epochs):
            ...
            while True:
                ...
                loss = self._policy.train_step(state, action, next_state, reward)
                losses.append(loss)
    ...
    def run_test(self):
        ...
        logger.info('Evaluating predictions...')
        for r_num, (states, actions, _, rewards, _) in enumerate(self._random_dataset.rollout_iterator()):
            pred_states = []
